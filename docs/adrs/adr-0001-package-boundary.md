...
Asset Processing Package Boundary
...
Define model cleanup, LOD, collision, texture, and runtime packaging as processing operation contracts before binding to any specific processor implementation.
